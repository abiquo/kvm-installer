...
#LIBVIRT_PKG=libvirt-0.9.4-23.el6_2.8.x86_64
#LIBVIRT_CLIENT_PKG=libvirt-client-0.9.4-23.el6_2.8.x86_64
...
if [[ "${ans}" == 'y'  ||  "${ans}" == 'yes' ]]; then
	...
	echo -n "Installing KVM... "
	yum install qemu-kvm -y >> $LOG_FILE 2>&1
	if [ $? == 0 ]; then
		echo "Done."
	else
		echo "Failed!"
